You are absolutely right! Mathematical formulas often render poorly in plain text. Let's reformat the explanations with proper LaTeX syntax within Markdown for better display in a `.md` file.
